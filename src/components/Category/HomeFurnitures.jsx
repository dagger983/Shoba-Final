...
const HomeFurnitures = ({ addToCart, isMobile }) => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const mensProducts = data.filter(product => product.category === "HomeFurnitures");
  ...
  return (
    <>
      ...
      <div className={`collection-container ${isMobile ? "mobile" : ""}`}>
        <h2 className="collection-title">Home Furnitures</h2>
